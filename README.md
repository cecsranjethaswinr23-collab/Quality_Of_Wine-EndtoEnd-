...
**Cloud & Deployment:** AWS (EC2 / ECR), Docker, Flask
...
**⚙️ Modular Architecture:** Stages: Data Ingestion, Data Validation,  Data Transformation, Model Training, and Model Evaluation.
